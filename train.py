...
class Instructor:
    ...
    # 使用__init__()方法来传递参数，比如赋值给对象属性等
    # 创建对象后一定会调用的函数
    def __init__(self, opt):
        self.opt = opt
        # 数据预处理：将训练好的数据"端端正正"传过来
...
def main():
    ...
    optimizers = {
        # 各种优化算法
        'adadelta': torch.optim.Adadelta,  # default lr=1.0  Torch是框架，optim是库
    ...
    # 超参数
    # 使用argparse设置超参的第一步是创建一个 ArgumentParser 对象
    ...
    parser.add_argument('--batch_size', default=4028, type=int)
